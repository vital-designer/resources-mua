...
<TABLE class="container4_whole" cellSpacing="0" cellPadding="0" border="0">
  <TR>
    <TD class="container4_tl"><img src="<%= SkinPath %>/spacer.gif" width="20px" height="30px" /></TD>
    <TD class="container4_tm"><TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
        <TR>
          ...
          <TD valign="bottom" width="100%" nowrap>
            <dnn:TITLE runat="server" id="dnnTITLE" cssclass="container4_title"/></TD>
    ...
    <TD class="container4_tr"><img src="<%= SkinPath %>/spacer.gif" width="20px" height="30px" /></TD>
  </TR>
  <TR>
    <TD class="container4_ml"><img src="<%= SkinPath %>/spacer.gif" width="20px" height="20px" /></TD>
    <TD class="container4_mm" id="ContentPane" runat="server" align="center"></TD>
    <TD class="container4_mr"><img src="<%= SkinPath %>/spacer.gif" width="20px" height="20px" /></TD>
  </TR>
  <TR>
    <TD class="container4_bl"><img src="<%= SkinPath %>/spacer.gif" width="20px" height="30px" /></TD>
    <TD class="container4_bm"><TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
        <TR>
    ...
    <TD class="container4_br"><img src="<%= SkinPath %>/spacer.gif" width="20px" height="30px" /></TD>
  </TR>
</TABLE>
<BR>
<BR>
