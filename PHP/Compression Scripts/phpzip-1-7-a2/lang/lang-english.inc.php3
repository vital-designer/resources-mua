<?
// --------------------------------------------------------------------------------
// PhpZip Application 1.6 - Language file : English
// --------------------------------------------------------------------------------
...
function Translate($text)
{
  ...
  switch ($text) {
    ...
    case "Visualisations" :
      $translated = "Views";
    break;
    case "Visualisation par défaut d'une archive" :
      $translated = "Default archive view";
    break;
    case "Plane" :
      $translated = "Flat";
    break;
    ...
    case "Dernière modification" :
      $translated = "Last modification";
    break;
    case "octet" :
      $translated = "byte";
    break;
    case "Aucun fichier sélectionné." :
      $translated = "No selected file";
    break;
    case "Extration abandonnée." :
      $translated = "Extraction cancelled";
    break;
    case "Confirmer l'extraction de" :
      $translated = "Confirm extraction of";
    break;
    case "Suppression abandonnée." :
      $translated = "Deletion cancelled";
    break;
    case "Confirmer la suppression de" :
      $translated = "Confirm delete of";
    break;
    case "Mise à jour abandonnée." :
      $translated = "Update cancelled";
    break;
    case "Confirmer la mise à jour de" :
      $translated = "Confirm update of";
    break;
    case "Confirmer" :
      $translated = "Confirm";
    break;
    ...
    case "Fermer" :
      $translated = "Close";
    break;
    case "Etat de la suppression des fichiers" :
      $translated = "Status of file deletion";
    break;
    case "fichiers supprimés" :
      $translated = "deleted files";
    break;
    case "Extraire dans" :
      $translated = "Extract to";
    break;
    case "Parcourir" :
      $translated = "Browse";
    break;
    case "Dans le dossier" :
      $translated = "In folder";
    break;
    case "" :
      $translated = "";
    break;
