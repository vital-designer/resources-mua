...
|| filemtime ($cached_filename) + $cache_expire_time * 60 < time() ) {
  ...
  echo 'IECapt.exe ' . escapeshellarg($website_url) . ' ' . escapeshellarg($cached_filename);
//  exit();
...
echo "<img src='cache/" . $website_url_md5 .'.'. $output_format ."'>";exit();
