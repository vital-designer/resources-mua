...
*/
  ...
  function AppPhpzipZipListTreeItem($p_zip, $p_list, $p_index, $p_prefix="", $p_last=0, $p_root=0)
  {
    ...
    echo "<a href='' class=file title='".$v_description_string."' onClick='PcjsZipFileOpenPopup(\"".$v_index_string."\",\"".$p_list[$p_index][filename]."\",\"".$p_zip->zipname."\",".($p_list[$p_index][folder]==true)."); return false;'>";
