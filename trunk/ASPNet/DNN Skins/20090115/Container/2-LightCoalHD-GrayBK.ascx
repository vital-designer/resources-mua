...
<link href="Container.css" rel="stylesheet" type="text/css" />
            <TABLE class="containermaster2_Coal" cellSpacing="0" cellPadding="4" align="center" border="0">
        <TR>
          <TD class="containerrow2b_Coal">
            <TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
              <TR>
                ...
                <TD valign="middle" width="100%" nowrap>&nbsp;<dnn:TITLE runat="server" id="dnnTITLE" cssclass="font2d"/></TD>
        ...
        <TR>
          <TD class="containerrow2c_Coal" id="ContentPane" runat="server" align="center"></TD>
        </TR>
        <TR>
          <TD class="containerrow2c_Coal"><TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
              <TR>
