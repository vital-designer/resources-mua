...
<%@ Register TagPrefix="dnn" TagName="ACTIONBUTTON4" Src="~/Admin/Containers/ActionButton.ascx" %>
      ...
      <TABLE class="containermaster42_Coal" cellSpacing="0" cellPadding="4" align="center" border="0">
        <TR>
          <TD class="containerrow4b_Coal">
            <TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
              <TR>
                ...
                <TD valign="middle" width="100%" nowrap>&nbsp;<dnn:TITLE runat="server" id="dnnTITLE" cssclass="font4d" /></TD>
        ...
        <TR>
          <TD class="containerrow4c2_Coal" id="ContentPane" runat="server" align="center"></TD>
        </TR>
        <TR>
          <TD class="containerrow4c2_Coal"><TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
              <TR>
